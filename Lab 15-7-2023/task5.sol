...
//after uncommenting we can not edit the constant variables , we can asign the value of 
//constants at the time of declaration once in a contract and it can not be changed afterwards.
CONSTANT_NUM = 100 ;
